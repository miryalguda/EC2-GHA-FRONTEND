...
const Deposit = () => {
  ...
  const handleSubmit = (event) => {
    ...
    let initialBalance = isDeposit ? totalState : totalState;
    let newTotal = isDeposit ? totalState + amount : totalState;

    setTotalState(newTotal);
    setTransactions([
      ...transactions,
      { deposit, amount, initialBalance, totalState },
    ]);

    axios
      .post("/trans", { deposit, totalState, initialBalance, newTotal })
