...
function Transfers() {
  ...
  return (
    <>
      ...
      >
        {" "}
        <h2>Internal Money Transfer to Other Accounts</h2>
      </div>
      <Card
        bgcolor=""
          ...
          show ? (
            <>
              ...
              <input
                ...
                onChange={(e) => setFromAccountnumber(e.currentTarget.value)}
              />{" "}
              <br />
              <label>
                <h4>Transfer To: </h4>
              ...
              <input
                ...
                onChange={(e) => setToAccountnumber(e.currentTarget.value)}
              />{" "}
              <br />
              Amount ($$$)
              <br />
