...
const Withdraw = () => {
  ...
  const handleSubmit = (event) => {
    let amount = isWithdraw ? withdraw : 0;
    let initialBalance = isWithdraw ? totalState : totalState;
    let newTotal = isWithdraw ? totalState - amount : totalState;
    setTotalState(newTotal);
    setTransactions([
      ...transactions,
      { withdraw, amount, initialBalance, totalState },
    ]);

    axios
      .post("/withdraw/", { withdraw, totalState, initialBalance, newTotal })
